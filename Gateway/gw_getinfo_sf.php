...
/*	#Get Identity
	...
	$arrIdentity = $API->comm('/interface/print', array('?name'=>'ether2'));
	//print_r($arrIdentity);
	echo $arrIdentity[0]['running'] .',';
	echo $arrIdentity[0]['slave'] .',';
	$disable = '';
	$disable = $arrIdentity[0]['disabled'] == 'false' ? 'Enable' : 'Disable';
	echo $disable;
